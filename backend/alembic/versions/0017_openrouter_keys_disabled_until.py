...
Revision ID: 0017_openrouter_keys_disabled_until
Revises: 0016_api_key_request_status_default
...
revision: str = "0017_openrouter_keys_disabled_until"
down_revision: str | Sequence[str] | None = "0016_api_key_request_status_default"
