...
鎖定 **React 18 + TS**(本專案走 **Next.js (App Router)** 路線)+ Redux Toolkit + RTK Query + Tailwind **v4**。版本以 `00-overview/01-versions.md` 為準(本專案 re-baseline:Next 14.2 / React 18.3 / Tailwind v4,**非** HE 模板的 React 19)。
